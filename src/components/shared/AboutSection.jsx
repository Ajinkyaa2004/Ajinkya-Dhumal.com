          ...
          <div className="relative z-10 flex flex-col h-full justify-between">
            <div>
              ...
              <p className="text-white/70 leading-relaxed text-base max-w-xl">
                I'm <strong className="text-white/90">Ajinkya Dhumal</strong> — a Product-Minded Full Stack Engineer who builds AI-powered, data-driven products end to end. Today I'm an <strong className="text-white/90">Elite Project Analyst, Queue at Hudl</strong>, where I get professional ice-hockey games tag-ready and keep a 24/7 analysis pipeline moving, and a <strong className="text-white/90">Full Stack Developer at Insight Fusion Analytics</strong>, shipping React/Next.js platforms processing 50K+ records/day with 1K+ daily active users.
                <br />
                <br />
