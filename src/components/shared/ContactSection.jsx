// Shared contact section — info column + Formspree contact form.
    ...
    <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} viewport={{ once: true }}>
      <div className="glass-panel rounded-[1.75rem] md:rounded-[2rem] p-4 sm:p-6 md:p-12 flex flex-col md:flex-row gap-8 md:gap-12 relative overflow-hidden border border-white/[0.06] hover:border-sky-500/30 transition-all duration-700">
        ...
        <div className="md:w-1/2 w-full relative z-10">
          <form action={CONTACT.formspree} method="POST" aria-label="Contact form" className="space-y-4 sm:space-y-5 backdrop-blur-xl p-4 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl border transition-all duration-500 bg-black/40 border-white/[0.06] hover:border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.3)]">
