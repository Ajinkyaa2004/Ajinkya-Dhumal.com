    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-start">
      ...
      <div>
        ...
        <div className="space-y-4">
          {WHY_PM.map((para, i) => (
            <motion.p key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: i * 0.08 }} viewport={{ once: true }} className="text-white/60 text-[15px] leading-relaxed">
              {para}
            </motion.p>
          ))}
        </div>
