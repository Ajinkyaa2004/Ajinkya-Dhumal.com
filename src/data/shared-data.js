...
export const EDUCATION = [
  { isWork: true, year: "May 2026 – Present", title: "Elite Project Analyst, Queue — Instat Ice Hockey", place: "Hudl · Sports Analytics", desc: "Promoted to Hudl's Queue team after a competitive internal selection, training, and final assessment. Prepare and quality-check professional ice hockey games so they're tag-ready, and operate the analysis queue across a 24/7 pipeline — with elevated admin access to Hudl's internal Queue systems. Built on hands-on analysis of 50+ performance metrics per game." },
